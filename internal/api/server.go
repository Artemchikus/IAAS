...
func (s *server) configureRouter() {
	...
	private.HandleFunc("/cluster/{cluster_id}/register", s.handleRegisterAccountInCluster).Methods("PUT")
	...
	cluster.HandleFunc("/floatingip", s.handleCreateFloatingIp).Methods("POST")
	cluster.HandleFunc("/floatingip/{floatingip_id}", s.handleDeleteFloatingIp).Methods("DELETE")
	cluster.HandleFunc("/floatingip/{floatingip_id}/addToPort", s.handleAddIPToPort).Methods("PUT")
	...
	cluster.HandleFunc("/router/{router_id}/add_subnet", s.handleAddSubnetToRouter).Methods("PUT")
	cluster.HandleFunc("/router/{router_id}/remove_subnet", s.handleRemoveRouterSubnet).Methods("PUT")
	...
	cluster.HandleFunc("/server/{server_id}/start", s.handleStartServer).Methods("PUT")
	cluster.HandleFunc("/server/{server_id}/stop", s.handleStopServer).Methods("PUT")
